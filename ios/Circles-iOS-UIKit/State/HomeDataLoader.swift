            ...
            placeGroup.notify(queue: .main) { [weak self] in
                ...
                if placesFetchComplete, !self.state.userOwnPlaces.isEmpty,
                   let cacheUserId = AuthService.shared.getUserId() {
                    ...
                    ProximityNotificationScheduler.shared.replan(places: self.state.userOwnPlaces, around: LocationService.shared.lastKnownLocation)
                }
        ...
        group.notify(queue: .main, execute: { [weak self] in
            ...
            if ownPlacesFetchComplete, !userPlacesAfterDedup.isEmpty,
               let cacheUserId = AuthService.shared.getUserId() {
                ...
                ProximityNotificationScheduler.shared.replan(places: userPlacesAfterDedup, around: LocationService.shared.lastKnownLocation)
            }
