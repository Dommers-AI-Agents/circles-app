...
class AddPlaceViewController: UIViewController, LegacyCategoryPickerDelegate {
    ...
    func fillFormWithMapItem(_ mapItem: MKMapItem) {
        ...
        DispatchQueue.main.async { [weak self] in
            ...
            let isResidentialAddress = AppleMapItemFormFill.isResidentialAddress(name: mapItem.name)
            ...
            let description = AppleMapItemFormFill.description(
            ...
            // Set category (POI category first, name hints when Apple gives none)
            let mapping = AppleMapItemFormFill.categoryMapping(poiCategory: mapItem.pointOfInterestCategory, name: mapItem.name)
            self.selectedCategory = mapping.category
            self.selectedSubcategory = mapping.subcategory
