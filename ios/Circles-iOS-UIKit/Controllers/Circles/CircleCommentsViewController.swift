...
class CircleCommentsViewController: BaseViewController {
    
    // MARK: - Properties
    private let circle: Circle
    private var comments: [CircleComment] = []
    ...
    @objc private func sendComment() {
        ...
        CircleService.shared.addCircleComment(circleId: circle.id, text: text) { [weak self] result in
    ...
    override func loadData(completion: (() -> Void)?) {
        CircleService.shared.getCircleComments(circleId: circle.id) { [weak self] result in
            DispatchQueue.main.async {
                switch result {
...
extension CircleCommentsViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let canDelete = comment.userId == currentUserId || circle.owner == currentUserId
    ...
    func tableView(_ tableView: UITableView, canEditRowAt indexPath: IndexPath) -> Bool {
        ...
        // User can delete if they are the comment author or the circle owner
        return comment.userId == currentUserId || circle.owner == currentUserId
    }
    ...
    func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        guard comment.userId == currentUserId || circle.owner == currentUserId else {
            return nil
        }
    ...
    private func deleteComment(at indexPath: IndexPath, completionHandler: @escaping (Bool) -> Void) {
        ...
        CircleService.shared.deleteCircleComment(circleId: circle.id, commentId: comment.id) { [weak self] result in
            DispatchQueue.main.async {
                switch result {
                case .success:
...
extension CircleCommentsViewController: UITextFieldDelegate {
...
class CircleCommentCell: UITableViewCell {
    ...
    func configure(with comment: CircleComment, canDelete: Bool = false) {
    ...
    @objc private func moreButtonTapped() {
        ...
        delegate?.circleCommentCell(self, didTapMoreButton: comment)
    }
...
// MARK: - CircleCommentCellDelegate
extension CircleCommentsViewController: CircleCommentCellDelegate {
    func circleCommentCell(_ cell: CircleCommentCell, didTapMoreButton comment: CircleComment) {
    ...
    func circleCommentCell(_ cell: CircleCommentCell, didTapLikeButton comment: CircleComment) {
        ...
        Logger.debug("Circle comment like tapped - not yet implemented")
    }
