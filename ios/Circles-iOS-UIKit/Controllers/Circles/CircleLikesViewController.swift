...
class CircleLikesViewController: BaseViewController {
    ...
    private func setupUI() {
        ...
        tableView.register(CircleLikeUserCell.self, forCellReuseIdentifier: "CircleLikeUserCell")
    }
    ...
    override func loadData(completion: (() -> Void)?) {
        ...
        CircleService.shared.fetchCircleLikes(id: circleId) { [weak self] result in
...
extension CircleLikesViewController: UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return users.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CircleLikeUserCell", for: indexPath) as! CircleLikeUserCell
...
extension CircleLikesViewController: UITableViewDelegate {
...
// MARK: - Circle Like User Cell
class CircleLikeUserCell: UITableViewCell {
