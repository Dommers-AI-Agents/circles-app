...
class ProfileViewController: BaseViewController, PlaceSearchable, FullScreenMapViewControllerDelegate {
    ...
    /// Owner bar button + brand storefront card.
    lazy var storefrontController: ProfileStorefrontController = {
        let controller = ProfileStorefrontController()
    ...
    func addStorefrontButtonIfEligible() {
        storefrontController.addStorefrontButtonIfEligible()
    }
    ...
    func refreshStorefrontCard() {
        storefrontController.refreshStorefrontCard()
    }
...
// MARK: - ProfileStorefrontControllerDelegate

extension ProfileViewController: ProfileStorefrontControllerDelegate {}
