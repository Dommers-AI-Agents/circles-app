...
ffmpeg -y -v error "${inputs[@]}" \
  ...
  -movflags +faststart out/import-tutorial.mp4
ffmpeg -y -v error -i out/import-tutorial.mp4 -c:v libx264 -preset slow -crf 26 -pix_fmt yuv420p -c:a aac -b:a 128k -movflags +faststart out/import-tutorial-web.mp4
# poster image for embeds (explicit poster = no black preview anywhere)
ffmpeg -y -v error -i out/import-tutorial-web.mp4 -frames:v 1 -q:v 2 out/import-tutorial-poster.jpg
echo "DONE"
ls -lh out/import-tutorial.mp4 out/import-tutorial-web.mp4
