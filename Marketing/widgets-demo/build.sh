#!/bin/bash
# build.sh — assemble the Widgets teaser: normalize the simctl take, cut dead
...
# Outputs: out/favcircles-widgets.mp4 (1080x2340) + -ig.mp4 (1080x1920).
set -eu
...
PROTECT = {"tab-widgets": (0.6, 2.4), "open-water": (0.4, 2.0), "log-glass": (0.3, 1.4),
