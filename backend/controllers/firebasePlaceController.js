...
const {
  normalizePhotosArray, overlayVenuePhotos, VENUE_TOP_FIELDS, VENUE_GOOGLE_FIELDS,
  overlayVenueFields, getGlobalSocial, fetchGlobalSocialMap, buildAddedByUserMap,
  isPlaceVisibleToViewer
} = require('../services/placeReadService');
