...
// Manually trigger daily summary for Wesley
...
async function triggerSummaryForWesley() {
  try {
    console.log('\n🚀 Manually triggering daily summary for Wesley...\n');
